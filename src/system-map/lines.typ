...
#let lines = (
  ...
  line(
    ...
    station([古湄], [GUMEI], dy: 3.),
    pin-round(dy: 3.5),
    station([真州], [ZHENZHOU], dx: 0.5),
    station([仪征客运枢纽], [YIZHENGKEYUNSHUNIU]),
    station([仪征开发区], [YIZHENG DEVELOPMENT ZONE], dx: 2.5),
    station([朴席], [PUXI], dx: 4.),
    pin-round(dx: 4.5),
    station([薛楼], [XUELOU], anchor: E),
    station([文汇西路], [WENHUIXILU], anchor: E),
    station([扬州西站], [YANGZHOUXI RAILWAY STATION], anchor: E, logo-anchor: S),
    pin(dy: 3.),
  ),
  line(
    id: "S6",
