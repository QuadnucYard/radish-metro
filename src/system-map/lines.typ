...
#let lines = (
  ...
  line(
    ...
    pin-round(x: -5., d: SW),
    station([静海寺], [JINGHAISI], y: 5.5, anchor: E),
    pin-round(y: 5., d: S),
  ...
  line(
    ...
    pin(y: -3.5, d: S, cfg: "L9-2", start-date: none),
    pin-round(y: -3.75, d: S),
